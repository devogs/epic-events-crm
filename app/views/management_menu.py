...
def management_menu(session: Session, employee: Employee, token: str) -> tuple[str, str | None]:
    ...
    while True:
        ...
        choice = Prompt.ask("Select an option [1-11]", choices=[str(i) for i in range(1, 12)]).strip()
        ...
        # Error handling
             ...
             console.print("[bold red]Invalid choice. Please select an option from 1 to 11.[/bold red]")
